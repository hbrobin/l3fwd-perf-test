...
pktgen.range.pkt_size("0", "start", 1280);
pktgen.range.pkt_size("0", "inc", 0);
pktgen.range.pkt_size("0", "min", 1280);
pktgen.range.pkt_size("0", "max", 1280);
...
pktgen.range.pkt_size("1", "start", 1280);
pktgen.range.pkt_size("1", "inc", 0);
pktgen.range.pkt_size("1", "min", 1280);
pktgen.range.pkt_size("1", "max", 1280);
