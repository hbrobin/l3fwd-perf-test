...
pktgen.range.pkt_size("0", "min", 1024);
pktgen.range.pkt_size("0", "max", 1024);
...
pktgen.range.pkt_size("1", "start", 1024);
pktgen.range.pkt_size("1", "inc", 0);
pktgen.range.pkt_size("1", "min", 1024);
pktgen.range.pkt_size("1", "max", 1024);
